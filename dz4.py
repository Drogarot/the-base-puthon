...
x_number = float(input('Введите действительное положительное число x: '))
y_number = int(input('Введите целое отрицательное число y: '))
def my_func(x_number, y_number):
    return pow(x_number, y_number)
print(my_func(x_number, y_number))
